...
class Main(QtWidgets.QMainWindow):
    ...
    def initDocument(self):
        ...
        self.printer.setPageMargins(QtCore.QMarginsF(0, 0, 0, 0),QtGui.QPageLayout.Unit.Point)
        ...
        self.text.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
